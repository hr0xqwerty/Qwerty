...
class WebSocketsConnection {
    constructor(connectToUrl, appInfo, serverPort) {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let addressResolve;
            const addressPromise = new Promise(resolve => addressResolve = resolve);
            ...
            this._wss.on('connection', ws => {
                ws.on('message', data => {
                    ...
                    if (this._promiseController.processResponse(message)) {
                        return;
                    }
                    const { method, params, id, result, error, session } = message;
                    if (typeof method !== 'string') {
                        return;
                    }
                    if (method !== 'connect' || typeof params !== 'string') {
                        return;
                    }
                    (_b = (_a = this._channelController) === null || _a === void 0 ? void 0 : _a.resolve) === null || _b === void 0 ? void 0 : _b.call(_a);
    ...
    disconnect() {
        var _a, _b, _c;
        (_b = (_a = this._channelController) === null || _a === void 0 ? void 0 : _a.reject) === null || _b === void 0 ? void 0 : _b.call(_a);
        (_c = this._wss) === null || _c === void 0 ? void 0 : _c.close();
        this._wss = undefined;
    }
    postMessage(method, params, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const message = { method, params, protocol: options === null || options === void 0 ? void 0 : options.protocol, version: options === null || options === void 0 ? void 0 : options.version, jsonrpc: '2.0' };
    ...
    deliverMessage(message, options) {
        var _a, _b;
        this._channelController.promise = (_b = (_a = this._channelController) === null || _a === void 0 ? void 0 : _a.promise) === null || _b === void 0 ? void 0 : _b.then(() => { var _a; return (_a = this._wss) === null || _a === void 0 ? void 0 : _a.clients.forEach(ws => ws.readyState === WebSocket.OPEN && ws.send(JSON.stringify(message))); }).catch(() => { return; });
    }
}

const ArweaveWalletServer = ArweaveApi(WebSocketsConnection);

export { ArweaveWalletServer };
